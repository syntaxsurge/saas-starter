  ...
  return (
    <input
      ...
      className={cn(
        ...
        "dark:bg-input/30 border-2 border-border dark:border-border",
        ...
        "focus-visible:ring-1 focus-visible:ring-primary/40 focus-visible:ring-offset-1 focus-visible:ring-offset-background",
        // Mark invalid states
